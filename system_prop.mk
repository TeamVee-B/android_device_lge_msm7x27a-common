...
# Display Composition
PRODUCT_PROPERTY_OVERRIDES += debug.composition.type="dyn"#MDP
PRODUCT_PROPERTY_OVERRIDES += persist.hwc.mdpcomp.enable="false"#true
...
PRODUCT_PROPERTY_OVERRIDES += ro.telephony.ril_class="LGEQualcommUiccRIL"
...
# Limit APPs
PRODUCT_PROPERTY_OVERRIDES += ro.sys.fw.bg_apps_limit="20"
